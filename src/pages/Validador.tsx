...
const CSM_NAMES: Record<string, string> = {
  ...
  "abautista@truora.com": "Andrea Bautista",
};
...
const VALIDADOR_CLIENTS: ValidadorClient[] = [
  ...
  { tci: "TCIbe3bf13eb4c7562a39887cabad6e1895", nombre: "Federación Nacional de Cafeteros", csm: "abautista@truora.com", grado: "100%" }, // consume por validación (doc+pasiva+TruFace). NO pertenece a la cartera / NO está en `clientes`; agregado con autorización de JP solo para /validador. CSM display = Andrea Bautista. Validado jun 2026: 4.479 (salto ~8x desde may)
