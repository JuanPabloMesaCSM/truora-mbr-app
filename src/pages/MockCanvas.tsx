...
const DI_MOCK_DATA = {
  ...
  data: {
    ...
    // Familia DOCUMENTO (grano proceso). Suma = 900 = familia doc de 10_declinados.
    // 10 motivos → el panel muestra top 8 + "Otros motivos" (2 motivos = 15).
    "7_razones_doc": [
      { bloque: "7_razones_doc", col1: "invalid_document_status",                 col2: "290" },
      { bloque: "7_razones_doc", col1: "blurry_image",                            col2: "240" },
      { bloque: "7_razones_doc", col1: "data_not_match_with_government_database",  col2: "150" },
      { bloque: "7_razones_doc", col1: "document_unregistered",                   col2: "90"  },
      { bloque: "7_razones_doc", col1: "missing_issue_number",                    col2: "45"  },
      { bloque: "7_razones_doc", col1: "invalid_qr_content",                      col2: "30"  },
      { bloque: "7_razones_doc", col1: "invalid_issue_date",                      col2: "25"  },
      { bloque: "7_razones_doc", col1: "document_has_expired",                    col2: "15"  },
      { bloque: "7_razones_doc", col1: "document_is_a_photocopy",                 col2: "8"   },
      { bloque: "7_razones_doc", col1: "invalid_mrz",                             col2: "7"   },
    ],
    // Familia ROSTRO (grano proceso). Suma = 600 = familia rostro de 10_declinados.
    // 8 motivos → con top 8 caben todos (sin "Otros").
    "8_razones_rostro": [
      { bloque: "8_razones_rostro", col1: "similarity_threshold_not_passed",         col2: "300" },
      { bloque: "8_razones_rostro", col1: "no_face_detected",                        col2: "120" },
      { bloque: "8_razones_rostro", col1: "risky_face_detected",                     col2: "80"  },
      { bloque: "8_razones_rostro", col1: "passive_liveness_verification_not_passed", col2: "40" },
      { bloque: "8_razones_rostro", col1: "face_not_detected",                       col2: "25"  },
      { bloque: "8_razones_rostro", col1: "invalid_video_file",                      col2: "15"  },
      { bloque: "8_razones_rostro", col1: "user_face_match_in_client_collection",    col2: "12"  },
      { bloque: "8_razones_rostro", col1: "user_face_match_in_fraud_collection",     col2: "8"   },
    ],
    "9_abandono": [
    ...
    // TODOS los motivos declinados (doc 900 + rostro 600 + otro 396 = 1896 = DI-1 col5).
    // 24 motivos → DI-10b muestra top 10 + "Otros (N)" sumando al total exacto.
    "10_declinados": [
      { bloque: "10_declinados", col1: "similarity_threshold_not_passed",          col2: "300" },
      { bloque: "10_declinados", col1: "invalid_document_status",                  col2: "290" },
      { bloque: "10_declinados", col1: "blurry_image",                             col2: "240" },
      { bloque: "10_declinados", col1: "validations_failed",                       col2: "185" },
      { bloque: "10_declinados", col1: "data_not_match_with_government_database",   col2: "150" },
      { bloque: "10_declinados", col1: "no_face_detected",                         col2: "120" },
      { bloque: "10_declinados", col1: "document_unregistered",                    col2: "90"  },
      { bloque: "10_declinados", col1: "risky_face_detected",                      col2: "80"  },
      { bloque: "10_declinados", col1: "risk_signal_detected",                     col2: "70"  },
      { bloque: "10_declinados", col1: "government_database_unavailable",          col2: "60"  },
      { bloque: "10_declinados", col1: "missing_issue_number",                     col2: "45"  },
      { bloque: "10_declinados", col1: "passive_liveness_verification_not_passed", col2: "40"  },
      { bloque: "10_declinados", col1: "max_retries_reached",                      col2: "35"  },
      { bloque: "10_declinados", col1: "invalid_qr_content",                       col2: "30"  },
      { bloque: "10_declinados", col1: "not_enough_credits_in_electronic_signature", col2: "28" },
      { bloque: "10_declinados", col1: "face_not_detected",                        col2: "25"  },
      { bloque: "10_declinados", col1: "invalid_issue_date",                       col2: "25"  },
      { bloque: "10_declinados", col1: "custom_question_max_retries_reached",      col2: "18"  },
      { bloque: "10_declinados", col1: "document_has_expired",                     col2: "15"  },
      { bloque: "10_declinados", col1: "invalid_video_file",                       col2: "15"  },
      { bloque: "10_declinados", col1: "user_face_match_in_client_collection",     col2: "12"  },
      { bloque: "10_declinados", col1: "document_is_a_photocopy",                  col2: "8"   },
      { bloque: "10_declinados", col1: "user_face_match_in_fraud_collection",      col2: "8"   },
      { bloque: "10_declinados", col1: "invalid_mrz",                              col2: "7"   },
    ],
    "11_friccion_usuario": [
