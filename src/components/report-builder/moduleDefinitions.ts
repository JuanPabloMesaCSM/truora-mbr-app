...
export const MODULES: Record<Product, { base: ModuleDef; optional: ModuleDef[] }> = {
  ...
  CE: {
    ...
    optional: [
      ...
      { id: '5_flujo_inbound', label: 'Resultados Flujo Inbound', desc: 'Dona + KPIs', description: 'Conversaciones recibidas, % que pasaron a agente humano y % resueltas exitosamente por el bot.', chart: 'donut' },
